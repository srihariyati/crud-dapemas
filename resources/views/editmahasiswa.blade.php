...
<head>
    ...
    <title>DAPEMAS | Edit Mahasiswa</title>
...
<body>
  ...
  <section id="appointment" class="appointment section-bg">
    <div class="container"><br/><br/><br/><br/>
      ...
      <form class="php-email-form" action="/mahasiswa/update" method="post">
      {{ csrf_field() }}<div class="form-row">

        <div class="col-md-4 from-group">
          <label> Nama Lengkap</label>
          <input class="form-control" type = "text"placeholder="{{$m->nama}}" name="nama" required="required"><br/>
        ...
        <div class="col-md-4 from-group">
          <label> NIM/NPM</label>
          <input class="form-control" type="text" name="nim_npm" placeholder="{{$m->nim}}" Induk Mahasiswa)" required="required">
          <div class="validate"></div>
        </div>
  ...
  </section><!-- end section input data-->
