          ...
          <div class="advance-search">
						<div class="container">
							<div class="row justify-content-center">
								<div class="col-lg-12 col-md-12 align-content-center">
									<form action="/siswa" method="GET">  <br>
										<div class="form-row">
          ...
          <table class="table table-responsive product-dashboard-table">
            ...
            @foreach($siswa as $ds)
              <tr>
                ...
                <td>{{$ds->status}}</td>
                <td>
                  <a href="/siswa/edit/{{$ds->id}}">Edit</a>&nbsp;&nbsp;&nbsp;
                  <a style="color:red;" href="/siswa/konfirmasihapus/{{$ds->id}}">Hapus</a>
                </td>
              </tr>
            @endforeach
            </tbody>
